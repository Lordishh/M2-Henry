...
span.innerHTML = span.innerHTML + ' Enuel'
...
function buildToDo(todo, index) {
  ...
  //Estamos creando un div: <div class="toDoShell"></div>
  const toDoText = document.createElement('span');
  //Creo un span: <span></span>
  toDoText.innerHTML = todo.description;
  //<span>comprar articulo</span>
  toDoText.id =  index;
  // <span id="3">comprar articulo</span>
  if(todo.complete === true) {
    toDoText.className = 'completeText';
    // <span id="3" class="completeText">comprar articulo</span>
  }
...
function buildToDos(toDos) {
  // Tu código acá:
  //[{description: "Desc 1", complete: true}, {description: "Desc 2", complete: false},...]
  //       | buildTodo({description: "Desc1", complete true}, o)        |{description: "Desc 2", complete: false}, 1)
